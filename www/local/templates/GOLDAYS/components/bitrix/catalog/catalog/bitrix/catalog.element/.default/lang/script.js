...
window.JCCatalogElement.prototype.QuantitySet = function(index)
{
	if (0 === this.errorCode)
	{
		...
		if (this.canBuy)
		{
			...
			this.obBuyBtn.innerHTML = '<img src="/bitrix/templates/GOLDAYS/images/icons/icon-round-white-in-cart.png" alt=""><div class="big">Отложить товар</div><div class="small">для примерки</div></a>'+BX.message('MESS_BTN_BUY');
		}
		else
		{
...
window.JCCatalogElement.prototype.UpdateRow = function(intNumber, activeID, showID, canBuyID)
{
	...
	if (-1 < intNumber && intNumber < this.obTreeRows.length)
	{
		...
		if (!!RowItems && 0 < RowItems.length)
		{
			...
			{
				BX.adjust(this.obTreeRows[intNumber].CONT, {props: {className: (extShowMode < countShow ? 'sizes inline clearfix' : 'bx_item_detail_size')}});
			}
			if (extShowMode)
			{

...
$arAllOptions = array(
	array("catalog_iblock", GetMessage("IPGEXPANSION_IBLOCK"), "N", array("select", $arIblocks))
);
$aTabs = array(
	...
	<tr>
		...
		<td width="60%">
            ...
            <?elseif($type[0]=="select"):?>
                <select id="<?echo htmlspecialcharsbx($arOption[0])?>" name="<?echo htmlspecialcharsbx($arOption[0])?>">

...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	?>
				...
				endforeach;
				?>
				<?if(!$sum_tov){$sum_tov=0;}?>
			<script>$('#tov').html("Отложенные изделия (<? echo $sum_tov; ?>)<img src='/bitrix/templates/GOLDAYS/images/icons/icon-round-black-cart.png' alt=''>"); </script>		
